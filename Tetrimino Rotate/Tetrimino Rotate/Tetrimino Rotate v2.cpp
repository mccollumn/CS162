/*
@Filename:		Tetrimino Rotate v2.cpp
...
@Description:	Generate seven unique 2-dimensional arrays that represent Tetriminos.
				...
				This version uses a 3D array instead of multiple 2D arrays.
*/
...
typedef int tArr[NUM_SHAPES][NUM_ROWS][NUM_COLS];
...
@return: none
*/
void initialize(tArr tetriminoArray);
...
@return: none
*/
void output(tArr tetriminoArray);
...
@return: none
*/
void printTetrimino(const tArr tetriminoArray, shapes tetrimino);
...
@return: none
*/
void rotateLeft(tArr tetriminoArray, shapes tetriminoShape);
...
@return: none
*/
void rotateRight(tArr tetriminoArray, shapes tetriminoShapes);
...
// ------------------------------------------------------------
void rotateRight(tArr tetriminoArray, shapes tetriminoShape) {
	int tmp[NUM_ROWS][NUM_COLS];
	for (int row = 0; row < NUM_ROWS; row++) {
		for (int col = 0; col < NUM_COLS; col++) {
